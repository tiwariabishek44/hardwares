        ...
        child: SafeArea(
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                'Continue (${PriceFormatter.formatPriceForDisplay(controller.grandTotal)})',
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
                ),
                    ...
                    children: [
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 6),
                            if (item['selectedVariantType'] != null &&
                                item['selectedVariantType'].isNotEmpty) ...[
                              Container(
                                padding: EdgeInsets.symmetric(
                                    horizontal: 8, vertical: 3),
                                decoration: BoxDecoration(
                      ...
                      // Rate Information
                      if (item['companyName'] != 'Marvel')
                        Row(
                          children: [
                            Flexible(
                              child: Text(
                                PriceFormatter.formatPriceForDisplay(rate),
                                style: TextStyle(
                                  fontSize: 15,
                            ...
                            SizedBox(width: 8),
                            Text(
                              '/ ${PriceFormatter.formatPriceForDisplay(totalPrice)}',
                              style: TextStyle(
                                fontSize: 14,
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        PriceFormatter.formatQuantity(quantity) +
                            (item['unit'] == 'meter' ? " mtr" : ' pic'),
                        style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w700,
                          color: Color(0xFF1976D2),
